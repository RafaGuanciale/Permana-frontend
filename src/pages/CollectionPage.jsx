        ...
        <div className="collectionPage__content">
          ...
          <div class="collectionPage__list">
            <div className="collectionPage__list__item">
              <img className="collectionPage__item__img" src={bleuChanel} alt="" />
            ...
            <div className="collectionPage__list__item">
              <img className="collectionPage__item__img" src={terreHermes} alt="" />
              <div className="collectionPage__item__info">
            ...
            <div className="collectionPage__list__item">
              <img className="collectionPage__item__img" src={bleuNoirNarciso} alt="" />
              <div className="collectionPage__item__info">
                <p className="collectionPage__item__brand">Bleu Noir</p>
                <p className="collectionPage__item__name">Narciso Rodriguez</p>
                <div className="collectionPage__item__tags">
            ...
            <div className="collectionPage__list__item">
              <img className="collectionPage__item__img" src={ligthBlueDB} alt="" />
              <div className="collectionPage__item__info">
            ...
            <div className="collectionPage__list__item">
              <img className="collectionPage__item__img" src={hommeIntenseDior} alt="" />
              <div className="collectionPage__item__info">
